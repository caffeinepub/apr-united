...
function AprUnitedImpactWebsite() {
  const founders = [
    {
  ...
  const ventures = [
    {
      ...
      description: "A calm, supportive AI experience designed to help people feel heard, guided, and emotionally stronger.",
      stats: ["24/7 support", "Personal AI guidance", "Built for trust"]
    },
    {
      name: "Venuewala",
      tag: "Smart venue discovery",
      description: "A fast, modern marketplace that helps people discover and compare venues with clarity, speed, and confidence.",
      stats: ["Location-first search", "Budget filtering", "High-intent leads"]
    },
    {
      name: "FinAssist AI",
      tag: "AI-powered finance guidance",
      description: "Smart financial assistance that helps users navigate decisions, understand options, and take control of their money.",
      stats: ["Finance clarity", "AI-driven insights", "Built for users"]
    },
    {
      name: "APR Labs",
      tag: "Ideas into products",
      description: "A venture studio engine to launch bold digital products that solve real problems in India and beyond.",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-neutral-950 text-white", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 overflow-hidden pointer-events-none", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-32 left-1/2 h-[34rem] w-[34rem] -translate-x-1/2 rounded-full bg-cyan-500/15 blur-3xl" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-[28rem] left-[8%] h-72 w-72 rounded-full bg-blue-500/10 blur-3xl" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-[14rem] right-[8%] h-72 w-72 rounded-full bg-indigo-500/10 blur-3xl" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-50 border-b border-white/10 bg-neutral-950/70 backdrop-blur-xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-10 w-10 items-center justify-center rounded-2xl bg-white text-neutral-950 font-bold shadow-2xl", children: "APR" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-white/60", children: "Venture Studio" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-lg font-semibold tracking-wide", children: "APR United" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "hidden items-center gap-8 text-sm text-white/70 md:flex", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#ventures", className: "transition hover:text-white", children: "Ventures" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#model", className: "transition hover:text-white", children: "Model" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#vision", className: "transition hover:text-white", children: "Vision" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#founders", className: "transition hover:text-white", children: "Founders" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#contact", className: "transition hover:text-white", children: "Contact" })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mx-auto grid max-w-7xl gap-12 px-6 pb-20 pt-20 lg:grid-cols-[1.2fr_0.8fr] lg:px-8 lg:pb-28 lg:pt-28", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6 inline-flex items-center gap-2 rounded-full border border-cyan-400/30 bg-cyan-400/10 px-4 py-2 text-sm text-cyan-200", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "max-w-4xl text-5xl font-semibold leading-tight tracking-tight md:text-7xl", children: [
            "We create",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-cyan-300", children: "impactful startups" }),
            " that look premium, move fast, and scale with purpose."
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-6 max-w-2xl text-lg leading-8 text-white/70 md:text-xl", children: "APR United is a modern venture studio focused on turning sharp ideas into serious brands. From AI wellness to smart marketplaces, we design products that feel trusted, ambitious, and ready for growth." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10 flex flex-col gap-4 sm:flex-row", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: "View Studio Vision"
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12 grid grid-cols-2 gap-4 md:grid-cols-4", children: metrics.map((metric) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "rounded-3xl border border-white/10 bg-white/5 p-5 shadow-xl backdrop-blur",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-semibold text-white", children: metric.value }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-white/60", children: metric.label })
              ]
            },
            metric.label
          )) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-[2rem] border border-white/10 bg-white/5 p-5 shadow-[0_0_80px_rgba(34,211,238,0.08)] backdrop-blur-xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-[1.5rem] border border-white/10 bg-neutral-900 p-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between border-b border-white/10 pb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-white/50", children: "Studio Snapshot" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-semibold", children: "APR United" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-full border border-emerald-400/30 bg-emerald-400/10 px-3 py-1 text-xs text-emerald-200", children: "Active Build Mode" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 space-y-4", children: ventures.map((venture, index2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs uppercase tracking-[0.25em] text-cyan-200/80", children: [
                      "0",
                      index2 + 1
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "mt-1 text-xl font-semibold", children: venture.name }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm text-cyan-200", children: venture.tag })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-xl border border-white/10 bg-black/20 px-3 py-2 text-xs text-white/60", children: "Venture" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-sm leading-7 text-white/65", children: venture.description }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 flex flex-wrap gap-2", children: venture.stats.map((stat) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "model", className: "mx-auto max-w-7xl px-6 py-20 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-10 max-w-2xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm uppercase tracking-[0.3em] text-cyan-300", children: "Studio Model" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-3 text-3xl font-semibold md:text-5xl", children: "A sharper way to build brands that matter." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-lg leading-8 text-white/65", children: "APR United combines startup thinking, premium design, and product execution into one unified system." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-6 md:grid-cols-3", children: pillars.map((pillar) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "rounded-[2rem] border border-white/10 bg-white/5 p-8 shadow-xl backdrop-blur",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-cyan-300 text-lg font-bold text-neutral-950", children: pillar.title.charAt(0) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-2xl font-semibold", children: pillar.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-base leading-8 text-white/65", children: pillar.text })
            ]
          },
          pillar.title
        )) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "ventures", className: "mx-auto max-w-7xl px-6 py-20 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-[2rem] border border-white/10 bg-gradient-to-br from-white/8 to-white/[0.03] p-8 md:p-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-10 lg:grid-cols-[0.9fr_1.1fr]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm uppercase tracking-[0.3em] text-cyan-300", children: "Featured Ventures" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-3 text-3xl font-semibold md:text-5xl", children: "Products built for real-world adoption." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-5 text-lg leading-8 text-white/65", children: "Every venture under APR United is positioned to solve a specific market problem with strong branding, practical utility, and digital scalability." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-5 md:grid-cols-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-[1.75rem] border border-white/10 bg-neutral-900 p-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-white/50", children: "AI Wellness" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "mt-2 text-2xl font-semibold", children: "SootheAI" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-sm leading-7 text-white/65", children: "Calm, emotionally intelligent support through a beautiful AI-first product experience." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-[1.75rem] border border-white/10 bg-neutral-900 p-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-white/50", children: "Marketplace" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "mt-2 text-2xl font-semibold", children: "Venuewala" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-sm leading-7 text-white/65", children: "A smart venue discovery platform designed to reduce friction between search, comparison, and decision." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-[1.75rem] border border-white/10 bg-neutral-900 p-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-white/50", children: "AI Finance" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "mt-2 text-2xl font-semibold", children: "FinAssist AI" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-sm leading-7 text-white/65", children: "Smart financial guidance powered by AI to help users make confident, informed money decisions." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-[1.75rem] border border-white/10 bg-neutral-900 p-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-white/50", children: "Studio Opportunity" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "mt-2 text-xl font-semibold", children: "What makes APR United valuable?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-sm leading-8 text-white/65", children: "Not just one product. A repeatable startup-building engine with stronger brand equity and a bigger long-term story." })
          ] })
        ] })
      ] }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "vision", className: "mx-auto max-w-7xl px-6 py-20 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-8 lg:grid-cols-[1fr_0.9fr]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-[2rem] border border-white/10 bg-white/5 p-8 md:p-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm uppercase tracking-[0.3em] text-cyan-300", children: "Vision" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-3 text-3xl font-semibold md:text-5xl", children: "Building one of the most ambitious new-age startup brands from India." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-5 max-w-2xl text-lg leading-8 text-white/65", children: "APR United is designed to become a recognizable launchpad for digital ventures that solve modern consumer problems with clarity, trust, and bold execution." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-[2rem] border border-cyan-400/20 bg-cyan-400/10 p-8 md:p-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm uppercase tracking-[0.3em] text-cyan-100", children: "Why this matters" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mt-5 space-y-4 text-base leading-8 text-white/80", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "• Strong umbrella brand for multiple startup launches" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "• Better investor storytelling than a single-product website" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "• Premium design language creates instant credibility" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "• Clear foundation for future traction and fundraising" })
          ] })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "founders", className: "mx-auto max-w-7xl px-6 py-20 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-10 max-w-2xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm uppercase tracking-[0.3em] text-cyan-300", children: "Leadership" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-3 text-3xl font-semibold md:text-5xl", children: "The founders behind APR United." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-lg leading-8 text-white/65", children: "A focused leadership team shaping APR United into a modern venture brand with strong ambition, execution, and long-term vision." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-6 md:grid-cols-3", children: founders.map((founder) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "rounded-[2rem] border border-white/10 bg-white/5 p-8 shadow-xl backdrop-blur",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-16 w-16 items-center justify-center rounded-2xl bg-white text-xl font-bold text-neutral-950", children: founder.name.split(" ").map((part) => part[0]).join("") }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "mt-6 text-2xl font-semibold", children: founder.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm uppercase tracking-[0.2em] text-cyan-300", children: founder.role }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-5 text-sm leading-7 text-white/65", children: founder.bio }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-5 flex flex-wrap gap-2", children: founder.focus.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  className: "rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs text-white/70",
                  children: item
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "section",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-[2.5rem] border border-white/10 bg-white/5 px-8 py-12 text-center shadow-2xl backdrop-blur-xl md:px-16", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm uppercase tracking-[0.35em] text-cyan-300", children: "APR United" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mx-auto mt-4 max-w-3xl text-3xl font-semibold md:text-5xl", children: "Ready to turn bold ideas into premium ventures?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mx-auto mt-5 max-w-2xl text-lg leading-8 text-white/65", children: "Let's build brands that feel credible from day one and grow into companies that truly matter." }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
                {
...
ReactDOM.createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsx(InternetIdentityProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(AprUnitedImpactWebsite, {}) }) })
);
